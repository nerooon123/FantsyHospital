...
namespace FantsyHospital.Model
{
    ...
    public partial class FantasyHospitalEntities : DbContext
    {
        public FantasyHospitalEntities()
            : base("name=FantasyHospitalEntities")
        {
        }
        ...
        public virtual DbSet<ICOD> ICOD { get; set; }
